...
interface LogoProps {
	/** px size of the outer square — default 36 */
	size?: number
	/** Background fill — default brand green */
	bg?: string
	/** Icon stroke colour — default white */
	stroke?: string
...
export function Logo({
	...
	// Scale the 256px icon grid to fill the square with padding
