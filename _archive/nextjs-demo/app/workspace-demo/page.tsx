...
interface Doc {
	...
	type: DocType
	kind: DocKind
	date: string // ISO date e.g. "2024-11-03"
	notes: string
	isNew?: boolean
}
...
function AppSidebar({
	...
	return (
		<Sidebar collapsible="icon">
			<SidebarHeader className="px-3 h-9">
				<div className="flex items-center gap-2">
					<Logo size={24} radius={4} className="shrink-0" />
	...
	return (
		<div className="flex h-full flex-col overflow-hidden">
			...
			<div className="relative flex h-9 shrink-0 items-end bg-muted/30">
				{/* Border that active tab can cover via z-index */}
...
export default function WorkspaceNewPage() {
	...
	function addUpload() {
		// placeholder — real app would open file picker and extract metadata
