...
// ============================================================================
// TYPES — re-exported from the shared contract (`../types/formatting`) so code
// still importing them from `./Toolbar` keeps working during the migration.
// ============================================================================

export type { FormattingAction, SelectionFormatting };
