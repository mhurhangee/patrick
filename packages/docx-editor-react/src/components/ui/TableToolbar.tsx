...
import type { TableAction, TableContext } from '../../types/table';

// ============================================================================
// TYPES — the data types now live in the shared contract (`../../types/table`);
// re-exported here so existing `./TableToolbar` importers keep working.
// ============================================================================

export type { BorderPreset, TableAction, TableContext, TableSelection, TableSplitConfig } from '../../types/table';
