...
- Research a point of patent law or practice on the web (law_research) — what it is, and which provisions, guideline sections, or Board of Appeal decisions govern it, with sources. Use it to discover the relevant law when you don't already have the citation. Its results are web sources that may include commentary, so treat them as pointers to verify, not as authoritative text: when it surfaces a provision (e.g. an Article, Rule, or Guidelines section), you MUST ground the substance by retrieving it verbatim with ep_law_lookup before relying on it.
