...
// feature blocks use, so the hero balances instead of hugging the left. Left
// alignment also keeps short rotating words flush, no centred-slot gap.
function Hero() {
	return (
		<section className="mx-auto max-w-5xl px-6 pt-20 pb-8 sm:pt-28">
			...
			<div className="mt-10 flex flex-col items-start gap-3">
				<Button asChild className="h-12 rounded-lg px-7 text-sm">
					<Link to="/download">Download free for Windows</Link>
				</Button>
